...
export function ReviewGenerateStep() {
  ...
  const letterData = useMemo((): EngagementLetterData | null => {
    ...
    return {
      ...
      chfcDisclosure: data.chfcDisclosure,
      riaDisclosure: data.riaDisclosure,
      ...
      conflictMitigations: data.conflictMitigations || { includeMitigations: true, mitigationStrategies: [] },
